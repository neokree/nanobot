...
class ProviderConfig(Base):
    ...
    auth_method: str = "claude-code"  # "claude-code" | "api-key"
    ...
    def _match_provider(
        ...
        for spec in PROVIDERS:
            ...
            if p and any(_kw_matches(kw) for kw in spec.keywords):
                # claude-code auth_method takes priority (AnthropicOAuthProvider)
                if p.auth_method == "claude-code" or spec.is_oauth or p.api_key:
                    return p, spec.name
