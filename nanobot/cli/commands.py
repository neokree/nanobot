...
def _make_provider(config: Config):
    ...
    Priority:
    1. claude-code auth_method → AnthropicOAuthProvider (subscription-based)
    2. openai_codex → OpenAICodexProvider (OAuth)
    3. custom → CustomProvider (direct OpenAI-compatible endpoint)
    4. Everything else → LiteLLMProvider
    """
    ...
    # 1. Anthropic OAuth via Claude Code subscription (nexus priority)
    ...
    # 3. Custom: direct OpenAI-compatible endpoint, bypasses LiteLLM
